...
@section('content')
    <div class="container p-top50 p-bot50">
        <div class="row">
            <h2 class="text-center m-bot50 h2">CHÍNH SÁCH BẢO MẬT</h2>
            ...
            <div class="ng-star-inserted">
                <div class="article mt-3 mb-3">
                    ...
                    <p><br>
                        <em>Bảo vệ dữ liệu là vấn đề của sự tin tưởng và bảo mật danh tính của quý khách vô cùng quan
                            ...
                            thông tin cần thiết và có liên quan đến giao dịch giữa chúng tôi và quý khách.</em>
                    </p>

                    <p><br>
                        <em>Chúng tôi chỉ giữ thông tin của quý khách trong thời gian luật pháp yêu cầu hoặc cho mục
                            đích mà thông tin đó được thu thập.</em>
                    </p>

                    <p><br>
                        <em>Quý khách có thể ghé thăm trang web mà không cần phải cung cấp bất kỳ thông tin cá nhân nào.
                            Khi viếng thăm trang web, quý khách sẽ luôn ở trong tình trạng vô danh trừ khi quý khách có
                            tài khoản trên trang web và đăng nhập vào bằng tên và mật khẩu của mình.</em>
                    </p>
                    ...
                    <p><br>
                        <em>Quy định Bảo mật của chúng tôi hoàn toàn tuân theo Đạo luật Bảo Mật 1988 và là phương châm
                            tốt nhất của nền công nghiệp.</em>&nbsp;
                    </p>
                    ...
                    <p>- Giao hàng quý khách đã mua tại AMI-FASHION.SHOP&nbsp;.<br>
                        ...
                        của quý khách.<br>
                        - Ngoài ra, chúng tôi sẽ sử dụng thông tin quý khách cung cấp để hỗ trợ quản lý tài khoản khách
                        hàng; xác nhận và thực hiện các giao dịch tài chính liên quan đến các khoản thanh toán trực
                        tuyến của quý khách; kiểm tra dữ liệu tải từ trang web của chúng tôi; cải thiện giao diện
                        và/hoặc nội dung của các trang mục trên trang web và tùy chỉnh để dễ dàng hơn khi sử dụng; nhận
                        diện khách đến thăm trang web; nghiên cứu về nhân khẩu học của người sử dụng; gửi đến quý khách
                        thông tin mà chúng tôi nghĩ sẽ có ích hoặc do quý khách yêu cầu, bao gồm thông tin về sản phẩm
                        và dịch vụ, với điều kiện quý khách đồng ý không phản đối việc được liên lạc cho các mục đích
                        trên.</p>

                    <p>&nbsp;</p>

                    <p>Chúng tôi có thể chia sẻ tên và địa chỉ của quý khách cho dịch vụ chuyển phát nhanh hoặc nhà cung
                        cấp của chúng tôi để có thể giao hàng cho quý khách.</p>
                    ...
                    <p>Các khoản thanh toán mà quý khách thực hiện qua trang web sẽ được xử lý bởi công ty thứ ba có
                        chứng nhận PCI. Quý khách phải cung cấp cho chúng tôi hoặc đại lý của chúng tôi hoặc trang web
                        những thông tin chính xác và phải luôn cập nhật thông tin và báo cho chúng tôi biết nếu có thay
                        đổi.&nbsp;</p>

                    <p>&nbsp;</p>

                    <p>Chi tiết đơn hàng của quý khách sẽ được chúng tôi lưu trữ nhưng vì lý do bảo mật, quý khách không
                        thể yêu cầu thông tin đó từ chúng tôi. Tuy nhiên, quý khách có thể kiểm tra thông tin đó bằng
                        cách đăng nhập vào tài khoản riêng của mình trên trang web hoặc ứng dụng. Tại đó, quý khách có
                        thể theo dõi đầy đủ chi tiết của các đơn hàng đã hoàn tất, những đơn hàng mở và những đơn hàng
                        sắp được giao cũng như quản lý thông tin về địa chỉ, thông tin về ngân hàng và những bản tin mà
                        quý khách đã đăng ký nhận. Quý khách cần bảo đảm là thông tin được truy cập một cách bí mật và
                        không làm lộ cho một bên thứ ba không có quyền. Chúng tôi sẽ không chịu trách nhiệm đối với việc
                        sử dụng sai mật khẩu trừ khi đó là lỗi của chúng tôi.</p>
                    ...
                    <p><strong>Bảo mật thông tin cá nhân</strong><br>
                        ...
                        - Xóa thông tin cá nhân của quý khách khi nó không còn cần thiết cho mục đích lưu trữ hồ sơ của
                        chúng tôi&nbsp;</p>
                    ...
                    <p>Các thông tin đó được thu thập cho mục đích phân tích và đánh giá để góp phần cải thiện trang
                        web, dịch vụ, và sản phẩm mà chúng tôi cung cấp. Những dữ liệu đó sẽ không có liên quan gì đến
                        các thông tin cá nhân khác.&nbsp;</p>
                    ...
                    <p>Như đã đề cập ở phần trên, AMI-FASHION.SHOP&nbsp;sẽ sử dụng tính năng của Google Analytics hoặc
                        ...
                        hàng trên Google Analytics hoặc Firebase Analytics. Hãy chọn mục thiết lập quảng cáo của Google
                        (https://www.google.com/settings/ads ), để bạn có thể tắt phần hiển thị quảng cáo từ Google
                        Analytics và tùy chỉnh quảng cáo trên hệ thống Google Display Network.&nbsp;</p>
